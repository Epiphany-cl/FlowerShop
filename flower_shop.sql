...
CREATE TABLE `t_cart_item`  (
  ...
  `flower_id` int(11) NULL DEFAULT NULL,
  `flower_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `flower_number` int(11) NULL DEFAULT NULL,
  `flower_price` decimal(10, 2) NULL DEFAULT NULL,
  `flower_img_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `t_flower`  (
  ...
  `flower_name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- Records of t_flower
-- ----------------------------
INSERT INTO `t_flower` VALUES (1, '红玫瑰花束×99', 99.00, 79.00, 'img/product/1.png');
INSERT INTO `t_flower` VALUES (2, '珊瑚色玫瑰', 18.00, 18.00, 'img/product/2.png');
INSERT INTO `t_flower` VALUES (3, '紫色郁金香花束', 19.00, 16.00, 'img/product/3.png');
INSERT INTO `t_flower` VALUES (4, '红玫瑰花束', 20.00, 20.00, 'img/product/4.png');
INSERT INTO `t_flower` VALUES (5, '多彩郁金香', 15.00, 15.00, 'img/product/5.png');
INSERT INTO `t_flower` VALUES (6, '粉红风信子', 17.00, 17.00, 'img/product/6.png');
INSERT INTO `t_flower` VALUES (7, '红色郁金香', 12.00, 12.00, 'img/product/7.png');
INSERT INTO `t_flower` VALUES (8, '粉红玫瑰', 25.00, 19.00, 'img/product/8.png');
INSERT INTO `t_flower` VALUES (9, '紫色风信子', 15.00, 15.00, 'img/product/9.png');
INSERT INTO `t_flower` VALUES (10, '浅蓝色玫瑰', 59.00, 49.00, 'img/product/10.png');
INSERT INTO `t_flower` VALUES (11, '金色郁金香', 25.00, 19.00, 'img/product/11.png');
...
CREATE TABLE `t_flower_detail`  (
  ...
  `describe_detail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
...
CREATE TABLE `t_order`  (
  ...
  `order_username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `order_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `order_nation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `order_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `order_paymentMode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '1:支票 2:到付 3:线上支付',
  `order_priceTotal` decimal(10, 2) NULL DEFAULT NULL,
  `user_id` int(11) NULL DEFAULT NULL,
  `state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '未支付、已支付、已发货、已签收',
...
CREATE TABLE `t_orderdetail`  (
  ...
  `flower_num` int(11) NULL DEFAULT NULL,
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'admin', 'admin@admin.com', '1234');
