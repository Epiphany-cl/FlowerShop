...
<div class="footer-top-area  section-bg-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                <div class="footer-widget footer-menu-widget clearfix"><h4 class="footer-title">信息</h4>
                    <div class="footer-menu">
                        <ul>
            ...
            <div class="col-xl-4 col-md-6 col-sm-6 col-12">
                <div class="footer-widget footer-about-widget"><h4 class="footer-title">关于我们的店铺</h4>
                    <div class="footer-logo d-none">
                        <div class="site-logo">
                            <img src="img/logo.png" alt="Logo">
                        </div>
                    </div>
                    <p>绽放真情，芬芳永恒；一束花，千言万语。情意传递，微笑绽放；
                        花开心间，温馨永驻。用花语述说，感动无限；真挚情感，化作花海。</p>
            ...
            <div class="col-md-6 col-12">
                <div class="footer-copyright-left">
                    <div class="ltn__copyright-design clearfix">
                        <p>&copy; <span class="current-year"></span> -只为你</p>
                    </div>
                </div>
            </div>
